...
names_fast = ["Ram","Hari",
"Sita","Gita","Nabin","Dilip","Suman","Anita","Bibek","Rajesh",
"Manisha","Arun","Kiran","Prakash","Asha","Santosh","Priya",
"Ramesh","Nina","Bishal","Sabina","Dipesh","Rekha","Raju",
"Rita","Keshav","Alisha","Binod","Muna","Dinesh","Puja",
"Subash","Saraswati","Sagar","Laxmi","Niraj","Anjali",
"Govinda","Swechha","Bikash","Kumari","Ujjwal","Samjhana",
"Ashish","Bimal","Sweta","Ravi","Mamata","Yogesh","Pooja","Suraj",
"Meera","Nischal","Namrata","Sanjay","Indira","Dipika","Yuvraj",
"Kalpana","Anup","Ganga","Sabin","Nirmala","Madan","Parbati","Manoj",
"Manju","Rabin","Sangita","Shyam","Usha","Nawaraj","Apsara","Rajendra",
"Smriti","Kamal","Sumitra","Biraj","Shova","Gopal","Luna","Narendra","Komal",
"Arjun","Pratima","Jivan","Jamuna","Akash","Karuna","Nabin","Meena",
"Nishma","Yaman","Himal","Prisha","Binaya","Aarya","Krishna","Anika",
"Shankar"]
last_names = ["Shrestha", "Limbu", "Gurung", "Rai", "Thapa", "Tamang", 
"Magar", "Karki", "Maharjan", "Bhattarai", "Lama", "Basnet", "Adhikari", 
"Rana", "Sherpa", "Khadka", "Subedi", "Poudel", "Chhetri", "Aryal", "Koirala", 
"Malla", "Joshi", "Pant", "Bista", "Sapkota", "Budhathoki", "Shakya", "Guragain", 
"Ghimire", "Jha", "Bhandari", "Oli", "Budha", "Luitel", "Pariyar", "Shiwakoti", 
"Roka", "Baniya", "Silwal", "Regmi" ]
